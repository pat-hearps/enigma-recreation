...
class BOMBE_TEST2:
    ...
    right_rotor = 'III'
    reflector = 'B'
    current_window_3 = 'ADW'
    ring_settings_3 = 'AAA'
    crib = "EARTHVENUSMARSSATURN"
    cypher = "DFJMJMKJFRHLOBPXHVCO"
    menu = {2: {'conxns': {'in': {9: 'out', 12: 'in'}, 'out': {7: 'out'}},
                'in': 'R',
                'menu_link': 'ZZB',
                'out': 'J'},
            3: {'conxns': {'in': {16: 'in'}, 'out': {10: 'in'}},
                'in': 'T',
                'menu_link': 'ZZC',
                'out': 'M'},
            7: {'conxns': {'in': {19: 'in'}, 'out': {2: 'out'}},
            'in': 'N',
                'menu_link': 'ZZG',
                'out': 'J'},
            9: {'conxns': {'in': {}, 'out': {2: 'in', 12: 'in'}},
            'in': 'S',
                'menu_link': 'ZZI',
                'out': 'R'},
            10: {'conxns': {'in': {3: 'out'}, 'out': {16: 'out'}},
                 'in': 'M',
                 'menu_link': 'ZZJ',
                 'out': 'H'},
            12: {'conxns': {'in': {2: 'in', 9: 'out'}, 'out': {19: 'out'}},
                 'in': 'R',
                 'menu_link': 'ZZL',
                 'out': 'O'},
            16: {'conxns': {'in': {3: 'in'}, 'out': {10: 'out'}},
                 'in': 'T',
                 'menu_link': 'ZZP',
                 'out': 'H'},
            19: {'conxns': {'in': {7: 'in'}, 'out': {12: 'out'}},
                 'in': 'N',
                 'menu_link': 'ZZS',
                 'out': 'O'},
            'config': {'conxns': {'in': {2: 'in', 9: 'out', 12: 'in'},
                                  'out': {2: 'in', 9: 'out', 12: 'in'}},
                       'in': 'R',
                       'menu_link': 'QQQ',
                       'out': 'R',
                       'test_char': 'R'}}
